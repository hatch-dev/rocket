  ...
  return (
    <div className="container">
      <div className="add-emp-title">
        <h2 className="emp-title">Add Employee</h2>
        <p>Enter client details to add a new client to the system.</p>
      </div>
      ...
      <div className="add-employee-form">
        <form onSubmit={onSubmit}>
         ...
         <div className="d-flex gap-2 align-items-center justify-content-end w-100">
            <button
              type="button"
              className="btn btn-secondary cm-btn-cancel"
              onClick={() => router.push("/rocket/admin/dashboard/employees")}
            >
              Cancel
            </button>

            <button type="submit" className="btn btn-primary cm-btn-save" disabled={loading}>
              {loading ? "Saving..." : "Save"}
            </button>
          </div>
        </form>
